    ...
    return (
        <div className="main-convert">
            ...
            <Container className="details-convert">
                ...
                <Container className='convert-rec3'> ETH <img className='eth-pic' src={ETH} alt="png"/>
                </Container>
                <Container className='arrow-icon'><BsArrowLeftRight className='arrow'/>
                </Container>
                <Container className='convert-rec4'>MYR <VscChevronDown className='dd-button' />
                </Container>
            </Container>
            </div>
