...
ws.onopen = function (evt) {
  ws.send(JSON.stringify({ authorize: "UKCr9DDh9KA6dPw" })); // First send an authorize call.
};
...
document.querySelector(
  "#app_contents > div > div > div > div > div.dc-page-overlay__content > div > div.dc-vertical-tab__content.dc-vertical-tab__content--floating > div > section > div > div > form > div > div.dc-timeline__flex.dc-timeline__flex--no-border > div.dc-timeline__container > div > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > div > p"
);

//*[@id="app_contents"]/div/div/div/div/div[2]/div/div[2]/div/section/div/div/form/div/div[3]/div[2]/div/div/table/tbody/tr[1]/td[2]/div/p
